      ...
      >
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 mt-2">Welcome back! Sign in to continue.</p>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="flex items-center justify-center px-4 py-2 border border-white/20 rounded-lg bg-white/5 text-gray-300 hover:bg-white/10 transition-all"
              >
